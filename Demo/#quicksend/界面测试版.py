...
window.iconphoto(True, PhotoImage(file=r'C:\Users\Administrator\Desktop\#quicksend\code\black.png'))  #21059
...
var_m0r = IntVar()
Scale_m0row = Scale(setup2, from_=1, to=11, orient=HORIZONTAL,
                    length=200, width=15, resolution=1,
                    tickinterval=5, repeatdelay=100,
...
Scale_rmax = Scale(setup4, from_=9, to=11, orient=HORIZONTAL,
                   length=200, width=15, resolution=2, tickinterval=2,
...
def run_Helper():
    ...
    for n in range(1, folders_nums + 1):
        for m in range(0, int(t) + 1):
            os.startfile(r'C:\Users\Administrator\Desktop\#quicksend\{}q-{}\{}{}({})\QuickSend.exe'.format(n, data, n,
                                                                                                           folder_name,
                                                                                                           m))
            time.sleep(1)
            # 身份弹窗
            select = pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\select.png',
                                             grayscale=False, confidence=0.6)
            time.sleep(0.5)
            abnormal = pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\abnormal2.png',
                                               grayscale=False, confidence=0.6)
            time.sleep(0.5)
            if select == None:
                if abnormal != None:
                    confirm = pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\confirm.png',
                                                      grayscale=False, confidence=0.6)
                    time.sleep(1)
                    pg.doubleClick(
                        pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\confirm.png',
                                                grayscale=False, confidence=0.6), duration=0.4)
                    time.sleep(2)
                else:
                    time.sleep(2)
                    break
                ...
                pass
            pg.click(
                pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\select.png', grayscale=False,
                                        confidence=0.6), duration=0.4)
            pg.press('enter')
            time.sleep(0.3)
            # 参数设置
            # 第一列
            ...
            setfile = pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\setfile.png',
                                              grayscale=False, confidence=0.6)
            time.sleep(0.5)
            # 判断是否打开了配置文件
            if setfile != None:
            ...
            pg.click(
                pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\setfile.png', grayscale=False,
                                        confidence=0.6), duration=0.3)  # 点击配置文件
            time.sleep(0.4)
            # 确认
            pg.doubleClick(
                pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\confirm.png', grayscale=False,
                                        confidence=0.7), duration=0.3)
            time.sleep(0.3)
            # 发送
            ...
            time.sleep(0.5)
            pg.click(
                pg.locateCenterOnScreen(r'C:\Users\Administrator\Desktop\#quicksend\code\minimize.png', grayscale=False,
                                        confidence=0.7), duration=0.4)
            m += 1
            time.sleep(0.5)
