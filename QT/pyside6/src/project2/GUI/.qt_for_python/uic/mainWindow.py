...
"")
        ...
        self.btn_queue.setAutoExclusive(True)
        ...
        self.btn_upload.setAutoExclusive(True)
        ...
        self.btn_fail.setAutoExclusive(True)
        ...
        self.bottom_space = QSpacerItem(1013, 13, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        self.widget1.setGeometry(QRect(44, 10, 981, 31))
        ...
        icon1 = QIcon()
        icon1.addFile(u"../resourse/min.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"../resourse/close.png", QSize(), QIcon.Normal, QIcon.Off)
