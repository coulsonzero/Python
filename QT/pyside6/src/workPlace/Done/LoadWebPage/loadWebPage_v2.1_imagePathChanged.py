...
class myWindow(QFrame):
    ...
    def setWindow(self):
        ...
        self.btn_close.setIcon(QIcon("C:/TGYC2/src/Photos/webviewer/close.png"))
        self.btn_close.setIconSize(QSize(20, 20))
        self.btn_close.clicked.connect(QCoreApplication.instance().quit)  # 关闭
        """
        self.topBox.addWidget(self.btn_close)
    ...
    def setupUi(self):
        ...
        self.btn_back.setIcon(QIcon("C:/TGYC2/src/Photos/webviewer/back.png"))
        ...
        self.btn_goAhead.setIcon(QIcon("C:/TGYC2/src/Photos/webviewer/go.png"))
        ...
        self.btn_refresh.setIcon(QIcon("C:/TGYC2/src/Photos/webviewer/refresh.png"))
        ...
        self.btn_home.setIcon(QIcon("C:/TGYC2/src/Photos/webviewer/home.png"))
        ...
        self.btn_clearCache.setIcon(QIcon("C:/TGYC2/src/Photos/webviewer/clearCache.png"))
        ...
        self.btn_search.setIcon(QIcon("C:/TGYC2/src/Photos/webviewer/search.png"))
        ...
        """
        self.topBox = QHBoxLayout(self.topBar)
        self.topBox.addWidget(self.btn_back)
        self.topBox.addWidget(self.btn_goAhead)
        self.topBox.addWidget(self.btn_refresh)
        self.topBox.addWidget(self.btn_home)
        self.topBox.addWidget(self.btn_search)
        self.topBox.addWidget(self.lineEdit_search)
        self.topBox.addWidget(self.btn_clearCache)

        self.btn_back.setFixedSize(30, 30)
        self.btn_back.move(self.topBar.x(), self.topBar.y()+5)
        self.btn_goAhead.setFixedSize(30, 30)
        self.btn_refresh.setFixedSize(30, 30)
        self.btn_home.setFixedSize(30, 30)
        self.btn_search.setFixedSize(30, 30)
        self.lineEdit_search.setFixedSize(30, 30)
        self.btn_clearCache.setFixedSize(30, 30)
    ...
    def resizeEvent(self, event):
        '''
        self._right_rect = [list(range(self.width() - 10, self.width() + 10)),
                            list(range(self.frame.y() + 20, self.frame.height() - 30))]
        '''
        self._right_rect = [list(range(self.frame.width() - 15, self.frame.width() + 15)),
                            list(range(self.frame.y() + 20, self.frame.height() - 30))]
        '''
        self._bottom_rect = [list(range(self.frame.x() + 20, self.frame.width() - 20)),
                             list(range(self.frame.height() - 10, self.frame.height() + 10))]
        '''
    ...
    def enterEvent(self, event):
        ...
        if self.on:
            ...
            # ic(range(self.x()+20, self.width() - 20))
            # ic(range(self.frame.y(), self.frame.y() + 50))
            # ic(event.pos().x() in self._top_rect[0])
            # ic(event.pos().y() in self._top_rect[1])
            # 右指针
