...
class myWindow(QFrame):
    ...
    def resizeEvent(self, event):
        self._right_rect = [list(range(self.width() - 10, self.width() + 10)), list(range(self.frame.y()+20, self.frame.height()-30))]
        self._bottom_rect = [list(range(self.frame.x()+20, self.frame.width()-20)), list(range(self.frame.height() - 10, self.frame.height() + 10))]
        self._corner_rect = [list(range(self.frame.width()-15, self.frame.width()+20)), list(range(self.frame.height()-15, self.frame.height()+15))]
        self._top_rect = [list(range(self.frame.x(), self.frame.width()-20)), list(range(self.frame.y(),self.frame.y()+ 50))]
