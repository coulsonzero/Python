...
from src.project1.Test.demo1.ui_mainWindow import Ui_Form
...
class MyWindow(QWidget, Ui_Form):
    ...
    def _init_main_window(self):
        ...
        h = self.label.height()
        self.pix = QPixmap(
            r"D:\code_python\CalPx_test\images\481ee7d90dfcc5c5418eaa8bf94370f2_cr.jpg")  # 注意修改Windows路径问题
